...
$mod_strings = array (
  ...
  'LNK_IMPORT_VCARD' => 'Import Customer vCard',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new Customer record by importing a vCard from your file system.',
  ...
  'LBL_LIST_FORM_TITLE' => 'Customers Λίστα',
  'LBL_MODULE_NAME' => 'Customers',
  'LBL_MODULE_TITLE' => 'Customers',
  'LBL_MODULE_NAME_SINGULAR' => 'Customer',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου Customers',
  'LNK_NEW_RECORD' => 'Δημιουργία Customer',
  'LNK_LIST' => 'Προβολή Customers',
  'LNK_IMPORT_CUSTM_CUSTOMERS' => 'Import Customers',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Customer',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Προβολή Ιστορικού',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Δραστηριότητες',
  'LBL_CUSTM_CUSTOMERS_SUBPANEL_TITLE' => 'Customers',
  'LBL_NEW_FORM_TITLE' => 'Νέα Customer',
  'LBL_IMPORT' => 'Import Customers',
  'LBL_ADDRESS_MAP' => 'Address Map',
);