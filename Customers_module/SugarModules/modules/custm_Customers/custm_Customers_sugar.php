 ...
 * PLACE ANY CUSTOMIZATIONS IN custm_Customers
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class custm_Customers_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'custm_Customers';
    public $object_name = 'custm_Customers';
    public $table_name = 'custm_customers';
